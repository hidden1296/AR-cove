...
import 'package:image_downloader/image_downloader.dart'; // Add this line to your dependencies
...
class ProductDetailPage extends StatelessWidget {
  ...
  Future<void> _downloadImage(String url) async {
    try {
      ...
      print("Downloaded image: $fileName, $path, $size, $mimeType");
    } catch (error) {
      print(error);
    }
  }
              ...
              Container(
                ...
                child: Align(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () => _downloadImage(productImageUrl),
                  ),
                ),
              ),
          ...
          Container(
            ...
            child: Align(
              ...
              child: IconButton(
                ...
                onPressed: () => _downloadImage(product.imageUrl),
              ),
            ),
          ),
          Padding(
